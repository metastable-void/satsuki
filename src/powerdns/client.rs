...
impl PowerDnsClient {
    pub fn new(base_url: impl Into<String>, api_key: impl Into<String>, server_id: impl Into<String>) -> Self {
        Self {
            http: Client::new(),
    ...
    fn url(&self, path: &str) -> String {
        format!("{}/servers/{}/{}", self.base_url, self.server_id, path.trim_start_matches('/'))
    }
